...
export const CITIES = [
  ...
  { name: 'Coleraine', slug: 'coleraine', county: 'Itasca', photo: 'https://images.unsplash.com/photo-1470770841072-f978cf4d019e?auto=format&fit=crop&w=800&q=80' },
  { name: 'Bovey', slug: 'bovey', county: 'Itasca', photo: 'https://images.unsplash.com/photo-1425913397330-cf8af2ff40a1?auto=format&fit=crop&w=800&q=80' },
  { name: 'Cohasset', slug: 'cohasset', county: 'Itasca', photo: 'https://images.unsplash.com/photo-1440342359743-84fcb8c21f21?auto=format&fit=crop&w=800&q=80' },
  ...
  { name: 'Keewatin', slug: 'keewatin', county: 'Itasca', photo: 'https://images.unsplash.com/photo-1472214103451-9374bd1c798e?auto=format&fit=crop&w=800&q=80' },
  { name: 'Virginia', slug: 'virginia', county: 'St. Louis', photo: 'https://images.unsplash.com/photo-1470770841072-f978cf4d019e?auto=format&fit=crop&w=800&q=80' },
